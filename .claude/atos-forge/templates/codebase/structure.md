...
**New Template:**
- Implementation: `atos-forge/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `atos-forge/workflows/{name}.md`
- Usage: Reference from command with `@/Users/igor.3.wolak.external/Downloads/.claude/atos-forge/workflows/{name}.md`

**New Reference Document:**
- Implementation: `atos-forge/references/{name}.md`
...
**atos-forge/**
- Purpose: Resources installed to /Users/igor.3.wolak.external/Downloads/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/igor.3.wolak.external/Downloads/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
