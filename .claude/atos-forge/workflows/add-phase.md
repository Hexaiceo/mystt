...
```bash
INIT=$(node /Users/igor.3.wolak.external/Downloads/.claude/atos-forge/bin/forge-tools.cjs init phase-op "0")
```
...
<step name="add_phase">
**Delegate the phase addition to forge-tools:**

```bash
RESULT=$(node /Users/igor.3.wolak.external/Downloads/.claude/atos-forge/bin/forge-tools.cjs phase add "${description}")
```
...
<success_criteria>
- [ ] `forge-tools phase add` executed successfully
