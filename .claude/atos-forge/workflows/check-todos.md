...
- `/forge:check-todos api` → filter to area:api only
</step>
...
- options:
  - "Work on it now" — move to done, start working
  - "Create a phase" — /forge:add-phase with this scope
  - "Brainstorm approach" — think through before deciding
  - "Put it back" — return to list
</step>
...
**Create a phase:**
Display: `/forge:add-phase [description from todo]`
...
node /Users/igor.3.wolak.external/Downloads/.claude/atos-forge/bin/forge-tools.cjs commit "docs: start work on todo - [title]" --files .planning/todos/done/[filename] .planning/STATE.md
```
