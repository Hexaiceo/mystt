...
```bash
INIT_RAW=$(node /Users/igor.3.wolak.external/Downloads/.claude/atos-forge/bin/forge-tools.cjs init progress --include state,roadmap,project,config)
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node /Users/igor.3.wolak.external/Downloads/.claude/atos-forge/bin/forge-tools.cjs summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node /Users/igor.3.wolak.external/Downloads/.claude/atos-forge/bin/forge-tools.cjs progress bar --raw)
```
