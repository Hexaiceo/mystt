...
```bash
PHASE_INFO=$(node /Users/igor.3.wolak.external/Downloads/.claude/atos-forge/bin/forge-tools.cjs find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node /Users/igor.3.wolak.external/Downloads/.claude/atos-forge/bin/forge-tools.cjs roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node /Users/igor.3.wolak.external/Downloads/.claude/atos-forge/bin/forge-tools.cjs find-phase "${PHASE}" --raw)
```
